...
var _require2 = require('./sign'),
  signLogin = _require2.signLogin;
module.exports = {
  shareTo: function () {
    var _shareTo = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(opts) {
        ...
        while (1) switch (_context.prev = _context.next) {
          ...
          case 4:
            return _context.abrupt("return", new Promise(function (resolve) {
              request({
                method: 'POST',
                url: "".concat(opts.endpoint).concat(api.shareTo),
                headers: {
    ...
    function shareTo(_x) {
      return _shareTo.apply(this, arguments);
    }
    return shareTo;
  }()
};