...
const Answer = ({ id, content, author, datePost, userAvatar }) => {
      ...
      <div className="thread-summary">
        ...
        <div className="thread-info">
          <ThreadContainer onClick={handleThreadClick}>
            ...
            <ThreadStats>
              {/* <InteractButton className="up-down-vote-btn">Upvote</InteractButton> */}
              <UpvoteFeatures id={id}/>
              <DownvoteFeatures id={id}/>
              {/* <InteractButton className="up-down-vote-btn">Downvote</InteractButton> */}
            </ThreadStats>
          </ThreadContainer>
        </div>
      </div>
